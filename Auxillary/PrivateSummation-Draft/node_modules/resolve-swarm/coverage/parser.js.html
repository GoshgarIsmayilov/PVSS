...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">module.exports = async function (importPath) {
...
function swarmgwMaker(opts) {
  opts = opts || {};
  var gateway;
  <span class="missing-if-branch" title="if path not taken" >I</span>if (opts.gateway) {
<span class="cstat-no" title="statement not covered" >    gateway = opts.gateway;</span>
  } else <span class="missing-if-branch" title="if path not taken" >I</span>if (opts.mode === 'http') {
<span class="cstat-no" title="statement not covered" >    gateway = 'http://swarm-gateways.net';</span>
  } else {
...
<div class='footer quiet pad2 space-top1 center small'>
  Code coverage
  generated by <a href="https://istanbul.js.org/" target="_blank">istanbul</a> at Thu Jan 31 2019 09:31:18 GMT+0800 (CST)
</div>
</div>
